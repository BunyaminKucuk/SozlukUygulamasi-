...
namespace Dictionary
{
    class yeniKelime
    {
        ...
        public void KelimeGuncelle(string turkcesi,string ingilizcesi,string t_turu,string i_turu,string cumle,GroupBox grup,string OrjIng)
        {
            ...
            {
                db.baglanti.Open();
                SqlCommand kelimeGuncelle = new SqlCommand("update kelimeler set TurkceAnlami=@TurkceAnlami,IngilziceAnlami=@IngilziceAnlami,Cumle=@Cumle , KelimeTuru=@KelimeTuru , IKelimeTuru=@IKelimeTuru where trim(IngilziceAnlami)=@Orj", db.baglanti);
                ...
                kelimeGuncelle.Parameters.AddWithValue("@Orj", OrjIng.Trim());
